...
class Miner {
    ...
    getNextBlock(rewardAddress, feeAddress) {
    ...
    static generateNextBlock(rewardAddress, feeAddress, blockchain) {
        ...
        if (rewardAddress != null) {
            let rewardTransaction = Transaction.fromJson({
                ...
                data: {
                    ...
                    outputs: [
                        {
                            amount: Config.bitcoin.getMiningReward(blockchain.getAllBlocks()), // satoshis format
        ...
        const difficulty = blockchain.nextBlockDifficulty();
